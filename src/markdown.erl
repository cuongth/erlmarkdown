%%%-------------------------------------------------------------------
%%% @author    Cuong Thai
%%% @copyright (C) 2014, Cuong Thai
%%%
%%% @end
%%% Created : 23 Jul 2014 by bronzeboyvn@gmail.com
%%%-------------------------------------------------------------------
...
%% cuongth: get class name after triple delimeters...
get_class([], _) -> none;
get_class([?LF | Tail], Ret) -> {lists:reverse(Ret), Tail};
get_class([H | T], Ret) -> get_class(T, [H | Ret]).
